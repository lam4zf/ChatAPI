...
To run the API, you can either create a new website in IIS and point to the root folder, or you can open the solution file (ChatApi/Source Code/ChatApi.sln) in Visual Studio.